---
title: "How to Use Soul Spec with Clawdbot"
date: 2026-02-20
description: "Step-by-step guide to configure your Clawdbot AI agent's personality using Soul Spec. Portable, structured, version-controlled."
categories: ["Guides"]
tags: ["clawdbot", "soul-spec", "ai-persona", "guide", "tutorial"]
slug: "clawdbot-soul-spec-guide"
---

## Overview

Clawdbot supports SOUL.md-based persona configuration natively. Soul Spec extends this with a structured, portable format that gives your agent a complete identity.

This guide shows you how to set up Soul Spec in your Clawdbot workspace.
...
### 2. Copy to Your Clawdbot Workspace

```bash
cp SOUL.md IDENTITY.md AGENTS.md MEMORY.md ~/.clawdbot/workspace/
```

Clawdbot automatically reads these files from its workspace directory.
...
| Locked to Clawdbot | Portable to any framework |
...
Soul Spec works across all SOUL.md-compatible frameworks. Your agent's personality isn't locked to Clawdbot:
