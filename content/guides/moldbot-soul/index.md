---
title: "How to Use Soul Spec with Moldbot"
date: 2026-02-20
description: "Step-by-step guide to configure your Moldbot AI agent's personality using Soul Spec. Portable, structured, version-controlled."
categories: ["Guides"]
tags: ["moldbot", "soul-spec", "ai-persona", "guide", "tutorial"]
slug: "moldbot-soul-spec-guide"
---

## Overview

Moldbot supports SOUL.md-based persona configuration natively. Soul Spec extends this with a structured, portable format that gives your agent a complete identity.

This guide shows you how to set up Soul Spec in your Moldbot workspace.
...
### 2. Copy to Your Moldbot Workspace

```bash
cp SOUL.md IDENTITY.md AGENTS.md MEMORY.md ~/.moldbot/workspace/
```

Moldbot automatically reads these files from its workspace directory.
...
| Locked to Moldbot | Portable to any framework |
...
Soul Spec works across all SOUL.md-compatible frameworks. Your agent's personality isn't locked to Moldbot:
