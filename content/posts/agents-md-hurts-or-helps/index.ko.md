...
### 관심사의 분리
Soul Spec은 모든 것을 하나의 파일에 넣지 않습니다. 정체성은 `SOUL.md`에, 코딩 규칙은 `AGENTS.md`에, 주기적 점검 루틴은 `HEARTBEAT.md`에. 각 파일은 명확한 목적이 있고, 에이전트는 관련된 것만 로드합니다.
