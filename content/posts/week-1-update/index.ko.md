...
| 지원 플랫폼 | 5 |
| SoulScan 규칙 | 53 |
| 총 다운로드 | 1,250+ (게임 엔진 플러그인) |

### 🔬 연구

포지션 페이퍼 "Soul-Driven Interaction Design"이 Zenodo에 게시되었습니다 ([DOI: 10.5281/zenodo.18678616](https://doi.org/10.5281/zenodo.18678616)). 의미 있는 데이터를 위한 사용자 확보 후 실증 후속 연구를 계획 중입니다.
